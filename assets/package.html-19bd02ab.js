import{_ as n,o as s,c as a,e}from"./app-c984cf19.js";const i={},l=e(`<p>常见的包管理工具：npm、pnpm、cnpm、yarn</p><p>包管理器可以轻松升级、卸载包，管理包的依赖。</p><h2 id="nvm" tabindex="-1"><a class="header-anchor" href="#nvm" aria-hidden="true">#</a> nvm</h2><p>nvm是管理node版本的工具，通过它可以在一台电脑上安装多个版本的node，并可随时切换。</p><p>安装前需要先卸载安装过的nodeJs</p><p>下载地址：https://github.com/coreybutler/nvm-windows/releases</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>nvm <span class="token parameter variable">-v</span>	<span class="token comment">#安装成功后，查看版本</span>
